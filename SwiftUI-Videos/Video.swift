...
enum VideoList {
    static let topTwelve = [
        ...
        Video(imageName: "90-90", title: "The 90/90 Rile", uploadDate: "January 24, 2019"),
        Video(imageName: "2018-setup", title: "Aluna - Monitor Your Asthma", uploadDate: "May 12, 2019"),
        ...
        Video(imageName: "hig", title: "Apple's Humen Interface Guidelines", uploadDate: "December 5, 2019"),
